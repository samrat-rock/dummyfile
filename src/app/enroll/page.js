...
function Page() {
  return (
    <>
      <nav className="container mx-auto bg-white shadow-lg px-4 mt-3 flex justify-between font-poppins py-2 items-center rounded-lg">
      ...
      <section className="container mx-auto bg-white rounded-lg py-5 my-5 font-poppins px-4">
  ...
  <div className="font-poppins py-3 flex gap-5">
    <div>
      <h4 className="font-bold py-5">Resume</h4>

      <div className="bg-[#013F47] rounded-3xl w-72 h-72 text-white">
        ...
        <div className="ml-10 w-56 h-44 overflow-hidden">
          <img
    ...
    <div className="pl-8 font-poppins py-5 flex-1">
      <h3 className="font-bold">Cover letter</h3>
      <div className="border-[1px] border-gray-200 py-2 my-6 pl-2 text-left text-gray-400 h-full">
        <p>
